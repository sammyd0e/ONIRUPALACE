...
const projects = [
  {
    ...
    description: "A new fire station was commissioned in Iru Kingdom to improve safety and protect lives and property.",
    image: fire,
    tags: ["#Oniru", "#LeGIT", "#Lagos"],
    demoUrl: "#",
    githubUrl: "#",
  },               
  {
    ...
    description:"We Provide Top Medical Service more than 15 professionals",
    image: health,
